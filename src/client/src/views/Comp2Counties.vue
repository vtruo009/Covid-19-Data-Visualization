<template>
  <div class="mt-5">
    <b-form inline @submit="initialFormSubmission">
      <b-input v-model="State1" required placeholder="Province/State1"></b-input>
      <b-input class="ml-3" v-model="County1" required placeholder="County1"></b-input>
      <b-input class="ml-5" v-model="State2" required placeholder="Province/State2"></b-input>
      <b-input class="ml-3" v-model="County2" required placeholder="County2"></b-input>
      <b-button type="submit" variant="primary" class="ml-5">Search</b-button>
    </b-form>

    <div v-if="showChart" class="mt-5">     <!-- this will only render if showChart is a truthy value -->
      <b-row>     <!-- row contains donut chart & selection -->
        <b-col>
          <DonutChart v-bind:data="chartData"/> <!-- will display whatever bind to it -->
        </b-col>
        <b-col>
