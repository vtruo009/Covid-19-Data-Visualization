<template>
  <div class="mt-5">
    <b-form inline @submit="initialFormSubmission">
      ...
      <b-input class="ml-3" v-model="Province1" required placeholder="State/Provinces"></b-input>
      <b-input class="ml-5" v-model="Country2" required placeholder="Country"></b-input>
      <b-input class="ml-3" v-model="Province2" required placeholder="State/Provinces"></b-input>
