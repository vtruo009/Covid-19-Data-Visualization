  ...
  <div class="mt-5 fadeIn">
    <b-form @submit="GetData">
      <b-row class="d-flex justify-content-center">
        <b-col lg="3" sm="8">
          <b-input v-model="County" class="m-2" required placeholder="County"></b-input>
        </b-col>
        <b-col lg="3" sm="8">
          <b-input class="m-2" v-model="State" required placeholder="State"></b-input>
        </b-col>
        <b-col lg="3" sm="8">
          <b-button block class="m-2" type="submit" variant="primary">Search</b-button>
        </b-col>
      </b-row>
    </b-form>
