<template>
  <div class="mt-5 fadeIn">
    <b-form inline @submit="searchCase">
      ...
      ></b-input>
      <b-button class="ml-3" type="submit" variant="primary" :disabled="waitingForResponse">Search</b-button>
      <b-button
        class="ml-3"
        variant="primary"
    ...
    <Success class="mt-4" v-show="success" v-bind:successMessage="successMessage" />
    <div v-show="caseFound" class="blackBackground p-5 mt-5">
      ...
      <b-row>
        <b-form @submit="updateCase">
          <b-row>
            <b-col>
              <b-form-group :disabled="waitingForResponse" label="Reporting Date">
                <b-form-datepicker
                  required
                  :min="minDate"
                  :max="maxDate"
            ...
            <b-col>
              <b-form-group label="State">
                <b-input :disabled="waitingForResponse" type="text" v-model="caseInformation.State"></b-input>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col>
              <b-form-group label="Age">
                <b-input :disabled="waitingForResponse" type="number" v-model="caseInformation.Age"></b-input>
              </b-form-group>
            </b-col>
            <b-col>
            ...
            <b-col>
              <b-form-group label="Type of Case">
                <b-form-select :disabled="waitingForResponse" v-model="caseInformation.TypeOfCase">
                  <b-form-select-option value="1">Confirmed</b-form-select-option>
                  <b-form-select-option value="2">Dead</b-form-select-option>
                  <b-form-select-option value="3">Recovered</b-form-select-option>
                </b-form-select>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row class="mt-3">
            <b-button
              ...
              variant="primary"
              :disabled="waitingForResponse"
            >Submit Update</b-button>
            <b-button
              class="ml-4"
              variant="danger"
              :disabled="waitingForResponse"
              @click="showDeleteModal"
            >Delete Case</b-button>
            <b-spinner class="ml-4" v-if="waitingForResponse"></b-spinner>
          </b-row>
        </b-form>
      </b-row>
    ...
    <b-modal ref="delete-modal" hide-footer hide-title>
      <b-overlay :show="formIsBusy" rounded="sm">
        <b-form @submit="deleteCase">
          ...
          <div class="mt-5">
            <b-button :disabled="formIsBusy" type="submit" variant="danger" class="float-right">Yes</b-button>
            <b-button
              :disabled="formIsBusy"
              variant="secondary"
      ...
      <b-overlay :show="formIsBusy" rounded="sm">
        <b-form @submit="sendInsertRequest">
          ...
          <b-row>
            <b-col>
              <b-form-group label="Case ID">
                <b-form-input type="number" v-model="insertCase.ID" required></b-form-input>
              </b-form-group>
            </b-col>
            <b-col>
          ...
          <b-row>
            <b-col>
              <b-form-group label="Country">
                <b-form-input v-model="insertCase.Country" required></b-form-input>
              </b-form-group>
            </b-col>
            <b-col>
              <b-form-group label="State">
          ...
          <b-row>
            <b-col>
              <b-form-group label="Age">
                <b-form-input type="number" v-model="insertCase.Age" required></b-form-input>
              </b-form-group>
            </b-col>
            <b-col>
              <b-form-group label="Gender">
